      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          >
            ...
            >
              <FiLinkedin className="text-cyan-400 text-lg group-hover:scale-110 transition-transform" />
            </a>
            <a
              href="mailto:kikaybenalla5@gmail.com"
              className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-cyan-400/20 border-2 border-cyan-400/30 hover:border-cyan-400 transition-all duration-300 group"
            >
              <FiMail className="text-cyan-400 text-lg group-hover:scale-110 transition-transform" />
            </a>
            <a
              ...
              className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-cyan-400/20 border-2 border-cyan-400/30 hover:border-cyan-400 transition-all duration-300 group"
            >
              <svg className="text-cyan-400 text-lg w-5 h-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
