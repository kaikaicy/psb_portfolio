          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3 mt-2">
                ...
                >
                  <FiLinkedin className="text-cyan-400 text-xl w-5 h-5 group-hover:scale-110 transition-transform" />
                </a>
                <a
                  href="mailto:kikaybenalla5@gmail.com"
                  className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center hover:bg-cyan-400/20 border-2 border-cyan-400/30 hover:border-cyan-400 transition-all duration-300 group"
                >
                  <FiMail className="text-cyan-400 text-xl w-5 h-5 group-hover:scale-110 transition-transform" />
                </a>
                <a
                  ...
                  className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center hover:bg-cyan-400/20 border-2 border-cyan-400/30 hover:border-cyan-400 transition-all duration-300 group"
                >
                  <svg className="text-cyan-400 text-xl w-5 h-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
