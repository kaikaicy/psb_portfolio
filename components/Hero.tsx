          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3 mt-2">
                ...
                >
                  <FiLinkedin className="text-blue-600 text-xl w-5 h-5" />
                </a>
                <a
                  href="mailto:kikaybenalla5@gmail.com"
                  className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-md hover:shadow-lg transition-shadow"
                >
                  <FiMail className="text-blue-600 text-xl w-5 h-5" />
                </a>
                <a
                  ...
                  className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-md hover:shadow-lg transition-shadow"
                >
                  <svg className="text-blue-600 w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
